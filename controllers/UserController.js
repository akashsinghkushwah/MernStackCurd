...
const { purge } = require('../routes/web');


//  setup
// configuration
cloudinary.config({
  cloud_name: 'dafusldly',
  api_key: '318116666674357',
  api_secret: 'OozdUbFWXg5RIjDInydPBhFfX_g' // Click 'View API Keys' above to copy your API secret
});
